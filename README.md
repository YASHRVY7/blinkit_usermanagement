## Blinkit User Management (NestJS + TypeORM + JWT)

A role-based user management service built with NestJS, TypeORM (PostgreSQL), Passport JWT authentication (access + refresh), and class-validator. Includes an automatic Admin seeder.
